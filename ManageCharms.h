...
namespace MHOASS {
	...
	public ref class ManageCharms : public System::Windows::Forms::Form
	{
		...
		LoadedData^ data;
	private: System::Windows::Forms::ComboBox^  cmbSkillFilters3;

	private: System::Windows::Forms::ComboBox^  cmbSkills3;
	private: System::Windows::Forms::ComboBox^  cmbAmount3;
	private: System::Windows::Forms::Button^  btnJap3;
	...
	public:
			...
			: language( language ), data(_data ), update_skills( true ), updating_charms( false ), sort_alphabetically( sort_alphabetically )
		{
			...
			InitFilter( cmbSkillFilters3 );
			
			cmbAmount1->SelectedIndex = 0;
			cmbAmount2->SelectedIndex = 0;
			cmbAmount3->SelectedIndex = 0;
			...
			cmbAmount3->LostFocus += gcnew EventHandler( this, &ManageCharms::cmbAmount_LostFocus );
			...
			cmbSkills3->DropDown += gcnew System::EventHandler( this, &ManageCharms::SkillCombo_DropDown );
			...
			cmbSkills3->DropDownClosed += gcnew System::EventHandler( this, &ManageCharms::SkillCombo_DropDownClosed );
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// lblSlots
			// 
			this->lblSlots->Anchor = static_cast<System::Windows::Forms::AnchorStyles>((System::Windows::Forms::AnchorStyles::Bottom | System::Windows::Forms::AnchorStyles::Left));
			this->lblSlots->AutoSize = true;
			this->lblSlots->Location = System::Drawing::Point(5, 106);
			...
			// btnAddNew
			// 
			this->btnAddNew->Anchor = static_cast<System::Windows::Forms::AnchorStyles>((System::Windows::Forms::AnchorStyles::Bottom | System::Windows::Forms::AnchorStyles::Left));
			this->btnAddNew->Location = System::Drawing::Point(78, 100);
			...
			this->btnSave->Location = System::Drawing::Point(150, 100);
			...
			this->groupBox1->Controls->Add(this->cmbSkills3);
			this->groupBox1->Controls->Add(this->cmbAmount3);
			...
			this->btnReset->Location = System::Drawing::Point(222, 101);
			...
			this->ClientSize = System::Drawing::Size(390, 399);
...
#pragma endregion
	private: 
		...
		Charm^ CreateCharm()
		{
			...
			if( cmbAmount3->Text != L"0" && cmbSkills3->SelectedIndex != -1 )
			{
				amount3 = Convert::ToInt32( cmbAmount3->Text );
				ability3 = Ability::FindAbility( (String^)cmbSkills3->SelectedItem );
				Assert( ability3 && amount3 >= -10 && amount3 <= 14, L"Create-a-charm skill amount3 is invalid" );
			}
			if( num_slots == 0 && !ability1 && !ability2 && !ability3 )
				return nullptr;
			...
			if( ability3 )
				ch->abilities.Add( gcnew AbilityPair( ability3, amount3 ) );
		...
		System::Void UpdateFilter( ComboBox^ skill, ComboBox^ filter, Ability^ banned1, Ability^ banned2 )
		{
			if( !update_skills )
				return;
			...
			if( filter->SelectedIndex == 0 )
			{
				...
				{
					if( ab != SpecificAbility::torso_inc && ab != banned1 && ab != banned2 )
			...
			else if( filter->SelectedIndex == 1 )
			{
				for each( Ability^ ab in the_list )
				{
					if( ab->tags.Count == 0 && ab != SpecificAbility::torso_inc && ab != banned1 && ab != banned2 )
						skill->Items->Add( ab->name );
				}
			}
			else
		...
		{
			UpdateFilter( cmbSkills2, cmbSkillFilters2, Ability::FindAbility( (String^)cmbSkills1->SelectedItem ), Ability::FindAbility( (String^)cmbSkills3->SelectedItem ) );
		}
 
		System::Void cmbSkillFilters1_SelectedIndexChanged(System::Object^  sender, System::EventArgs^  e)
		{
			UpdateFilter( cmbSkills1, cmbSkillFilters1, Ability::FindAbility( (String^)cmbSkills2->SelectedItem ), Ability::FindAbility( (String^)cmbSkills3->SelectedItem ) );
		}

		System::Void cmbSkillFilters3_SelectedIndexChanged(System::Object^  sender, System::EventArgs^  e)
		{
			UpdateFilter( cmbSkills3, cmbSkillFilters3, Ability::FindAbility( (String^)cmbSkills1->SelectedItem ), Ability::FindAbility( (String^)cmbSkills2->SelectedItem ) );
		}
		...
		System::Void cmbSkills1_SelectedIndexChanged(System::Object^  sender, System::EventArgs^  e)
		{
			...
			{
				Ability^ ab = Ability::FindAbility( (String^)cmbSkills1->SelectedItem );
				UpdateFilter( cmbSkills2, cmbSkillFilters2, ab, nullptr );
				UpdateFilter( cmbSkills3, cmbSkillFilters3, ab, nullptr );
			}
		}
		...
		System::Void cmbSkills2_SelectedIndexChanged(System::Object^  sender, System::EventArgs^  e)
		{
			...
			{
				Ability^ ab = Ability::FindAbility( (String^)cmbSkills2->SelectedItem );
				UpdateFilter( cmbSkills1, cmbSkillFilters1, ab, nullptr );
				UpdateFilter( cmbSkills3, cmbSkillFilters3, ab, nullptr );
			}
		}

		System::Void cmbSkills3_SelectedIndexChanged(System::Object^  sender, System::EventArgs^  e)
		{
			if( cmbSkills3->SelectedIndex == 0 )
				cmbSkills3->SelectedIndex = -1;
			else
			{
				Ability^ ab = Ability::FindAbility( (String^)cmbSkills3->SelectedItem );
				UpdateFilter( cmbSkills1, cmbSkillFilters1, ab, nullptr );
				UpdateFilter( cmbSkills2, cmbSkillFilters2, ab, nullptr );
			}
		}
		...
		System::Void lstCharms_SelectedIndexChanged(System::Object^  sender, System::EventArgs^  e)
		{
			...
			if( ch->abilities.Count > 0 )
			{
				...
				if( ch->abilities.Count > 1 )
				{
					...
					if( ch->abilities.Count > 2 )
					{
						SwitchToAbility( cmbSkills3, ch->abilities[ 2 ]->ability );
						cmbAmount3->Text = Convert::ToString( ch->abilities[ 2 ]->amount );
					}
				}
			}
			cmbSkills1->EndUpdate();
			cmbSkills2->EndUpdate();
			cmbSkills3->EndUpdate();
		}
		...
		System::Void btnImport_Click(System::Object^  sender, System::EventArgs^  e)
		{
			...
			dlg.Filter = StaticString( MyCharmList ) + L"|mycharms.txt";
			dlg.FilterIndex = 0;
				...
				skill_form.selected_ability_index > -1 )
			{
				...
				if( sender == btnJap1 )
				{
					if( ability == Ability::FindAbility( (String^)cmbSkills2->SelectedItem ) )
						cmbSkills2->SelectedIndex = -1;
					if( ability == Ability::FindAbility( (String^)cmbSkills3->SelectedItem ) )
						cmbSkills3->SelectedIndex = -1;
				...
				else if( sender == btnJap3 )
				{
					...
					cmbSkillFilters3->SelectedIndex = 0;
					cmbSkills3->SelectedItem = ability->name;
				}
			}
		}
