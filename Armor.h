...
ref struct Armor : public AdvancedSearchOptions
{
	...
	System::String^ name;
	System::String^ chn_name;
	System::String^ eng_name;
	unsigned hr, level, num_slots, defence, max_defence, rarity, difficulty, index, family, ping_index, male_image, female_image;
	int ice_res, water_res, fire_res, thunder_res, dragon_res;
	Gender gender;
	HunterType type;
	bool torso_inc, no_skills, arena, chakra, gunner_def;
	Ability^ danger;
