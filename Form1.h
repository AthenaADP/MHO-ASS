...
#pragma region Members
	...
	private: MHOASS::NumericUpDownLvl^  nudLevel;
	private: MHOASS::NumericUpDownHR^  nudHR;
	private: System::Windows::Forms::NumericUpDown^  nudWeaponSlots;
	private: System::Windows::Forms::GroupBox^  groupBox1;
	private: System::Windows::Forms::Label^  lblLevel;
	private: System::Windows::Forms::Label^  lblHRQuests;
...
#pragma endregion
	...
	public:
		...
		void AddSolution( String^ line, const unsigned version )
		{
			...
			num_decorations = num_torso_decorations + num_non_torso_decorations;
			...
			unsigned num_pot_skills = Convert::ToUInt32( split[ 12 + num_decorations + num_skills ] );
			...
			solution->CalculateData( int( nudLevel->Value ), int( nudHR->Value ) );
		...
		void LoadConfig( String^ file, const bool lang )
		{
			...
			if( IO::File::Exists( file ) )
			{
				...
				else
				{
					...
					nudLevel->Value = Convert::ToInt32( fin.ReadLine() );
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->lblHRQuests = (gcnew System::Windows::Forms::Label());
			this->lblSlots = (gcnew System::Windows::Forms::Label());
			this->nudLevel = (gcnew MHOASS::NumericUpDownLvl());
			this->nudHR = (gcnew MHOASS::NumericUpDownHR());
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->nudLevel))->BeginInit();
			...
			this->groupBox1->Controls->Add(this->lblHRQuests);
			...
			// lblHRQuests
			// 
			this->lblHRQuests->AutoSize = true;
			this->lblHRQuests->Location = System::Drawing::Point(7, 52);
			this->lblHRQuests->Name = L"lblHRQuests";
			this->lblHRQuests->Size = System::Drawing::Size(57, 13);
			this->lblHRQuests->TabIndex = 2;
			this->lblHRQuests->Text = L"HR quests";
			// 
			// lblSlots
			// 
			...
			// nudLevel
			// 
			this->nudLevel->Anchor = static_cast<System::Windows::Forms::AnchorStyles>((System::Windows::Forms::AnchorStyles::Top | System::Windows::Forms::AnchorStyles::Right));
			this->nudLevel->BackColor = System::Drawing::SystemColors::Control;
			this->nudLevel->Enabled = false;
			this->nudLevel->Location = System::Drawing::Point(100, 20);
			this->nudLevel->Maximum = System::Decimal(gcnew cli::array< System::Int32 >(4) {5, 0, 0, 0});
			this->nudLevel->Minimum = System::Decimal(gcnew cli::array< System::Int32 >(4) {1, 0, 0, 0});
			this->nudLevel->Name = L"nudLevel";
			this->nudLevel->Size = System::Drawing::Size(44, 20);
			this->nudLevel->TabIndex = 1;
			this->nudLevel->TextAlign = System::Windows::Forms::HorizontalAlignment::Center;
			this->nudLevel->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) {5, 0, 0, 0});
			// 
			// nudHR
			// 
			...
			this->nudHR->Enabled = false;
			this->nudHR->Location = System::Drawing::Point(100, 50);
			this->nudHR->Maximum = System::Decimal(gcnew cli::array< System::Int32 >(4) {4, 0, 0, 0});
			...
			this->nudHR->TabIndex = 3;
			this->nudHR->TextAlign = System::Windows::Forms::HorizontalAlignment::Center;
			this->nudHR->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) {4, 0, 0, 0});
			// 
			// lblLevel
			// 
			this->lblLevel->AutoSize = true;
			this->lblLevel->Location = System::Drawing::Point(7, 22);
			...
			this->mnuOptions->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(10) {this->mnuClearSettings, 
				this->toolStripSeparator1, this->mnuAllowBadSkills, this->mnuAllowLowerTierArmor, this->toolStripSeparator2, this->mnuMaxResults, 
				this->mnuPrintDecoNames, this->mnuSortSkillsAlphabetically, this->mnuShowRequiredSkillPoints, this->mnuSpendSpareSlots});
			...
			this->cmbCharmSelect->Items->AddRange(gcnew cli::array< System::Object^  >(4) {L"Use no charms", L"Use my charms", L"Use up to one skill charms", 
				L"Use up to two skill charms"});
			...
			this->Name = L"Form1";
			this->Text = L"Athena\'s ASS for MHO";
			this->groupBox1->ResumeLayout(false);
			this->groupBox1->PerformLayout();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->nudWeaponSlots))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->nudLevel))->EndInit();
...
private: 
	System::Void FormulateQuery( const bool danger, const bool use_gunner_skills, List_t< Skill^ >^ skills )
	{
		...
		query->level = int( nudLevel->Value );
	...
	unsigned UpdateResultDecorations( System::Text::StringBuilder% sb, List_t< Decoration^ >% decorations, const bool torso )
	{
		...
		String^ suffix = torso ? StaticString( InTorso ) : "";
	...
	System::Void UpdateResultString( List_t< Solution^ >^ solutions )
	{
		...
		for each( Solution^ solution in solutions )
		{
			...
			if( solution->decorations.Count > 0 )
			{
				...
				{
					offset += UpdateResultDecorations( sb, solution->body_decorations, true );
					offset += UpdateResultDecorations( sb, solution->non_body_decorations, false );
				}
				else
				{
					offset += UpdateResultDecorations( sb, solution->decorations, false );
				}
			}
...
#undef UpdateMenu
		nudLevel->UpdateEditText();
		nudHR->UpdateEditText();
		lblHRQuests->Text = StaticString( HRQuests );
		lblLevel->Text = StaticString( Level );
		...
		cmbCharmSelect->Items[ 2 ] = StaticString( UseUpToOneSkillCharms );
		cmbCharmSelect->Items[ 3 ] = StaticString( UseOnlyTwoSkillCharms );
